             ...
             <div class="container mx-auto grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    ...
                    <div class="space-y-4 text-slate-300">
                        ...
                        <p class="flex items-center"><i class="fas fa-envelope text-[#ff3ecb] mr-4"></i><span>info@siwscollege.edu.in</span></p>
                    </div>
                </div>
    ...
    <footer class="text-slate-300">
        <div class="container mx-auto px-6 py-12">
            ...
            <div class="flex flex-col-reverse md:flex-row justify-between items-center text-center md:text-left">
                <p class="text-slate-500 mt-4 md:mt-0">&copy; <span id="year"></span> SIWS College. All Rights Reserved. Developed By Rahul</p>
